...
typedef enum {NO_LAYER_TYPE, INPUT_LAYER, CONV_LAYER, FC_LAYER,
 ...
 ROUTE_LAYER, DROPOUT_LAYER, SOFTMAX_LAYER, NUM_LAYER_ELEMENTS} LAYER_TYPE;
typedef enum {NO_ACTIVATION, SIGMOID, TANH, RELU, LEAKY_RELU, ELU, SELU} LAYER_ACT;
typedef enum {NO_OPERATION, N_CONV2D, N_FC} NIST_OP;
