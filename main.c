...
int main(void)
{
    ...
    // aspen_dnn_t *yolov3_dnn = apu_create_dnn("data/cfg/yolov3_aspen.cfg", "data/yolov3/yolov3_data.bin");
    ...
    nasm_t *resnet50_nasm = apu_create_nasm(resnet50_dnn, 100e6, 100, 128);
    // // if (bert_nasm == NULL) 
    // // {
    ...
    rpool_add_nasm (rpool, resnet50_nasm, 1.0, "data/resnet50/batched_input_128.bin");
    // rpool_add_nasm (rpool, gpt2_nasm, 1.0, "data/gpt2/gpt2_124M_text_len_128_embedded_input.bin");
    ...
    void *dog_data = aspen_load_input ("data/resnet50/batched_input_128.bin", input_params, sizeof(float));
    ...
    //     char filename[256];
    //     sprintf (filename, "data/yolov3/yolov3_cat_output_128.bin");
    ...
    // // LAYER_PARAMS output_order[] = {BATCH, MAT_N, MAT_M, 0};
    // float *layer_output = ase_get_nasm_result (yolov3_nasm, output_order);
    // void *expected_output = load_arr ("data/yolov3/yolov3_cat_output_128.bin", 2*85*10647*sizeof(float));
    // compare_float_array (expected_output, layer_output, 2*85*10647, 1e-2, 1e-4, 20);
