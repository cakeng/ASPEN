...
int main(void)
{
    ...
    nasm_ldata_t *ldata = &yolov3_nasm->ldata_arr[yolov3_nasm->num_ldata - 1];
    void *expected_output = load_arr ("data/yolov3_cat_output_1.bin", 85*10647*sizeof(float));
    compare_float_array (expected_output, layer_output, 85*10647, 1e-2, 1e-4, 20);
