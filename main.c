...
int main(void)
{
    ...
    // nasm_t *resnet50_nasm = apu_create_nasm(resnet50_dnn, 200e6, 100, 128);
    // // // if (bert_nasm == NULL) 
    // // // {
    ...
    nasm_t *resnet50_nasm = apu_load_nasm_from_file ("data/resnet50_B1_M50_2.0e+08.nasm", resnet50_dnn);
    ...
    // dse_wait_for_nasm_completion (bert_nasm);
    // dse_wait_for_nasm_completion (resnet50_nasm);
    dse_wait_for_nasm_completion (resnet50_nasm);
    // dse_wait_for_nasm_completion (bert_4_nasm);
