...
int main(void)
{
    ...
    nasm_t *resnet50_nasm = apu_create_nasm(resnet50_dnn, 1e6, 100, 1);
    ...
    // nasm_t *resnet50_nasm = apu_load_nasm_from_file ("data/resnet50_S480_B1_M100_1.0e+07.nasm", resnet50_dnn);
    ...
    void *dog_data = aspen_load_input ("data/batched_input_64.bin", input_params, sizeof(float));
    ...
    for (int i = 0; i < 1; i++)
    {
        ...
        char filename[256];
        sprintf (filename, "data/resnet50_layer0.bin");
